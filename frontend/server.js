...
console.log('Mode: CommHub Direct Integration (No backend required)');
...
app.get('/health', (req, res) => {
  res.json({ status: 'ok', mode: 'commhub-direct' });
});
...
app.listen(PORT, () => {
  ...
  console.log('All API calls go directly to CommHub - no backend proxy needed');
});
